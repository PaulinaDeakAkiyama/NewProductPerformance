...
## Cleaning data 
reduced the size of the dataset considerably by dealing with data types and None values.
...
## Number of products bought and website clicks
